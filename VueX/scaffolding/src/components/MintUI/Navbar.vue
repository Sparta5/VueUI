...
export default {
  ...
  watch:{
      active(){
        // this.active=='1'?this.selected='aa':
        // this.active=='2'?this.selected='bb':
        // this.active=='3'?this.selected='cc': 
        // this.selected='dd'
        switch(this.active){
          case '1':
            this.selected = 'aa';
