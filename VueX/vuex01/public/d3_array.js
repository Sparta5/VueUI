...
!(function (t, n) {
  ...
  class InternSet extends Set {
    ...
    add(t) {
      return super.add(w(this, t));
    }
    delete(t) {
      return super.delete(b(this, t));
    }
  }
  function M({ _intern: t, _key: n }, r) {
    const e = n(r);
    return t.has(e) ? t.get(e) : r;
  }
  function w({ _intern: t, _key: n }, r) {
    const e = n(r);
    return t.has(e) ? t.get(e) : (t.set(e, r), r);
  }
  function b({ _intern: t, _key: n }, r) {
    const e = n(r);
    ...
    if ((r && 2 !== r.length) || n.length > 1) {
      ...
      return (
        n.length > 1
          ...
          : ((r = t.map(r)), e.sort((t, n) => I(r[t], r[n]))),
        F(t, e)
      );
    }
    return t.sort(O(r));
  ...
  function C(t, n, r) {
    ...
    if (i > 0) {
      let r = Math.round(t / i),
        e = Math.round(n / i);
      for (
        r * i < t && ++r, e * i > n && --e, f = new Array((o = e - r + 1));
        ++u < o;
  ...
  function D(t, n, r) {
    var e = (n - t) / Math.max(0, r),
      ...
      f = e / Math.pow(10, o);
    return o >= 0
      ? (f >= R ? 10 : f >= U ? 5 : f >= z ? 2 : 1) * Math.pow(10, o)
      : -Math.pow(10, -o) / (f >= R ? 10 : f >= U ? 5 : f >= z ? 2 : 1);
  }
  function G(t, n, r) {
    let e;
    for (;;) {
  ...
  function H() {
    ...
    function e(e) {
      ...
      for (var p = d.length; d[0] <= a; ) d.shift(), --p;
      for (; d[p - 1] > h; ) d.pop(), --p;
      var y,
        v = new Array(p + 1);
      for (o = 0; o <= p; ++o)
        ((y = v[o] = []).x0 = o > 0 ? d[o - 1] : a), (y.x1 = o < p ? d[o] : h);
      if (isFinite(i)) {
        if (i > 0)
          for (o = 0; o < u; ++o)
            null != (f = l[o]) &&
      ...
      } else for (o = 0; o < u; ++o) null != (f = l[o]) && a <= f && f <= h && v[c(d, f, 0, p)].push(e[o]);
      return v;
    }
    return (
      (e.value = function (n) {
  ...
  function Q(t, n, r = 0, e = t.length - 1, o) {
    for (o = void 0 === o ? I : O(o); e > r; ) {
      if (e - r > 600) {
        const f = e - r + 1,
          i = n - r + 1,
          u = Math.log(f),
          l = 0.5 * Math.exp((2 * u) / 3),
          s = 0.5 * Math.sqrt((u * l * (f - l)) / f) * (i - f / 2 < 0 ? -1 : 1);
        Q(
          t,
          n,
          Math.max(r, Math.floor(n - (i * l) / f + s)),
          Math.min(e, Math.floor(n + ((f - i) * l) / f + s)),
          o
        );
      }
      const f = t[n];
      let i = r,
        u = e;
      for (V(t, r, n), o(t[e], f) > 0 && V(t, r, e); i < u; ) {
        for (V(t, i, u), ++i, --u; o(t[i], f) < 0; ) ++i;
        for (; o(t[u], f) > 0; ) --u;
      }
      0 === o(t[r], f) ? V(t, r, u) : (++u, V(t, u, e)),
        u <= n && (r = u + 1),
        n <= u && (e = u - 1);
    }
    return t;
  ...
  function W(t, n, r) {
    if (
      ...
      if ((n = +n) <= 0 || e < 2) return K(t);
      if (n >= 1) return J(t);
      var e,
        o = (e - 1) * n,
        f = Math.floor(o),
        i = J(Q(t, f).subarray(0, f + 1));
      return i + (K(t.subarray(f + 1)) - i) * (o - f);
    }
  }
  function X(t, n) {
    let r,
  ...
  function rt(t) {
    ...
    for (var n = -1, r = K(t, et), e = new Array(r); ++n < r; )
  ...
  (t.Adder = g),
    ...
    (t.groupSort = function (t, r, e) {
      return (
        2 !== r.length
          ? q(k(t, r, e), ([t, r], [e, o]) => n(r, o) || n(t, e))
          : q(_(t, e), ([t, e], [o, f]) => r(e, f) || n(t, o))
      ).map(([t]) => t);
    }),
    (t.groups = N),
    (t.histogram = H),
    ...
    (t.indexes = function (t, ...n) {
      return j(t, Array.from, T, n);
    }),
    (t.intersection = function (t, ...n) {
      (t = new InternSet(t)), (n = n.map(ot));
      t: for (const r of t)
        for (const e of n)
          if (!e.has(r)) {
            t.delete(r);
    ...
    (t.rank = function (t, r = n) {
      ...
      let i, u;
      return (
        Uint32Array.from(e, (t, n) => n)
          .sort(r === n ? (t, n) => I(e[t], e[n]) : O(f))
          .forEach((t, n) => {
    ...
    (t.thresholdFreedmanDiaconis = function (t, n, r) {
      return Math.ceil(
        (r - n) / (2 * (W(t, 0.75) - W(t, 0.25)) * Math.pow(a(t), -1 / 3))
      );
    }),
    (t.thresholdScott = function (t, n, r) {
      return Math.ceil(((r - n) * Math.cbrt(a(t))) / (3.49 * v(t)));
    }),
